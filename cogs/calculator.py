...
class Calculator(commands.Cog):
  ...
  @commands.command(invoke_without_command=True, aliases = ["maths"])
  ...
  @commands.command(aliases = ['addition', 'sum'])
  async def add(self, ctx, a = None, b = None):
    """Add two numbers together."""
    
    if a == None or b == None:
      embed = ErrorEmbed.error("Missing Command Arguments", "You need to specify two numbers to add.")
      await ctx.send(embed = embed)
    else:
      try:
        a = int(a)
  ...
  @commands.command(aliases = ['subtract', 'difference', 'diff', 'subtraction'])
  ...
  @commands.command(aliases = ['multiply', 'multiplication', 'product', 'multi'])
  ...
  @commands.command(aliases = ['divide', 'quo', 'quot', 'quotient'])
  ...
  @commands.command(aliases = ['ceiling'])
  ...
  @commands.command(aliases=['fd', 'floordivision'])
  ...
  @commands.command(aliases=['sr', 'squareroot'])
  ...
  @commands.command(aliases=['pow', 'exp', 'exponent'])
  ...
  @commands.command(aliases=['cotangent'])
  ...
  @commands.command(aliases=['cosecant', 'csc'])
  ...
  @commands.command(aliases=['asine'])
  ...
  @commands.command(aliases=['acosine'])
  ...
  @commands.command(aliases=['atangent'])
  ...
  @commands.command(aliases=['acotangent'])
  ...
  @commands.command(aliases=['asecant'])
  ...
  @commands.command(aliases=['acosecant', 'acsc'])
  ...
  @commands.command(aliases=['sineh'])
  ...
  @commands.command(aliases=['cosineh'])
  ...
  @commands.command(aliases=['tangenth'])
  ...
  @commands.command(aliases=['asineh'])
  ...
  @commands.command(aliases=['acosineh'])
  ...
  @commands.command(aliases=['atangenth'])
